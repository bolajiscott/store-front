                ...
                <div class="fl fr-ns pt0-ns pa2-ns w-50-l w-40-m w-100">
                    ...
                    <div class="w-100 fl f7 pv1 ">
                        <span class="f6 pointer flex items-center noselect">
                            <span class="w1 tc pv1 br--left ba b--black-40" @click="delItemQty(record)">
                                -
                            </span>
                            <span class="w3 tc pv1 bb bt b--black-40">
                                {{Quantity}}
                            </span>
                            <span class="w1 tc pv1 br--right ba b--black-40" @click="addItemQty(record)">
                                +
                            </span>
                        </span>
                    </div>
                    ...
                    <div class="fl w-100 f6 pv2 pb3">
                        <span @click="addItem(record)" class="f6-ns f7 fl  ph3 tc pv2 ba b--black-40">Add to Cart</span>
                    </div>
        ...
        methods:{
            ...
            addItemQty(item){
                ...
                if(app.shoppingBasket === null && app.shoppingBasket === undefined) {
                    if (app.shoppingBasket.items[item.PricelistlineID] === null || app.shoppingBasket.items[item.PricelistlineID] === undefined) {
                        app.shoppingBasket.items[item.PricelistlineID].Quantity = this.Quantity
                    }
                }
                app.updateCart()
            },
            ...
            updateCart() {
                if(this.shoppingBasket === null && this.shoppingBasket === undefined) {
                    this.shoppingBasket.items = this.shoppingBasket.items.filter(({Quantity}) => Quantity !== 0)
                    this.updateProductlist()
                    this.cartItemsQty = this.shoppingBasket.items.length
